"""
Django settings for hello_43329 project.
...
WSGI_APPLICATION = 'hello_43329.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hello_43329 API",
    "DESCRIPTION": "API documentation for hello_43329 App",
    "VERSION": "v1",
}
